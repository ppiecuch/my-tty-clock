...
#define HAVE_SYS_IOCTL_H 1 /* Define to 1 if you have the <sys/ioctl.h> header file. */
...
#define HAVE_TIOCGWINSZ 1 /* Define if you have TIOCGWINSZ */
...
#define PACKAGE "toilet" /* Name of package */
#define PACKAGE_NAME "toilet" /* Define to the full name of this package. */
#define PACKAGE_STRING "toilet 0.3" /* Define to the full name and version of this package. */
#define PACKAGE_VERSION "0.3" /* Define to the version of this package. */
#define VERSION "0.3" /* Version number of package */
